...
- Installe les hooks Claude Code en forme exec native `command` + `args`, rend `PreToolUse` exhaustif et fail-closed face aux nouveaux noms d’outils, gouverne la délégation `Agent`, migre les anciens hooks ForgeAI et préserve les hooks tiers.
